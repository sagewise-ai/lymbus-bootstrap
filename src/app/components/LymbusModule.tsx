                ...
                >
                  ...
                  <div className="bg-brand-bg/50 border border-brand-border/30 rounded-4 rounded-tl-none p-4 d-d-flex gap-1.5 align-align-items-center">
                    <Motion.div 
                      ...
                      className="w-1.5 h-1.5 bg-brand-blue/40 rounded-circle" 
                    />
                    <Motion.div 
                      animate={{ scale: [1, 1.2, 1] }} 
                      transition={{ repeat: Infinity, duration: 1, delay: 0.2 }}
                      className="w-1.5 h-1.5 bg-brand-blue/60 rounded-circle" 
                    />
                    <Motion.div 
                      animate={{ scale: [1, 1.2, 1] }} 
                      transition={{ repeat: Infinity, duration: 1, delay: 0.4 }}
                      className="w-1.5 h-1.5 bg-brand-blue/80 rounded-circle" 
                    />
                  </div>
                </Motion.div>
              )}
