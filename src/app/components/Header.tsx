      ...
      <div className="d-flex align-items-center gap-4 flex-fill justify-content-end">
        ...
        <div className="position-relative flex-fill" style={{'maxWidth':'448px'}}>
          ...
          <input 
            ...
            placeholder="Search..." 
            className="w-100 h-9 bg-brand-bg rounded-3 pl-10 pr-4 text-sm focus:outline-none focus:ring-1 focus:ring-brand-blue/50 transition-all border-none"
          />
        </div>
              ...
              <>
                ...
                >
                  <div className="p-4 border-bottom border-brand-bg d-flex align-items-center justify-content-between">
                    ...
                    <button className="fw-bold text-brand-blue text-uppercase tracking-widest hover:underline" style={{'fontSize':'10px'}}>Clear All</button>
                  </div>
