...
function Icon() {
  return (
    <div className="size-full overflow-hidden position-relative flex-shrink-0" data-name="Icon">
...
function DecorativeIcon() {
  return (
    <div className="position-absolute opacity-10 lg:right-[-1px] top-0 lg:size-[192px] lg:p-[32px] pe-none" style={{'right':'-24px', 'padding':'24px'}} data-name="Container">
      <Icon />
    </div>
  );
}
...
function LymbusBadge() {
  return (
    <div className="px-3 d-flex align-items-center gap-2 rounded-circle flex-shrink-0 w-fit" style={{'backgroundColor':'#4f39f6', 'height':'24px'}} data-name="Container">
...
export function InsightFirstCard() {
  return (
    <div 
      className="border position-relative w-100 lg:h-[200px] overflow-hidden d-flex align-items-center" style={{'borderColor':'#e0e7ff', 'borderRadius':'24px', 'minHeight':'160px'}} 
      data-name="InsightFirstCard" 
      style={{ backgroundImage: "linear-gradient(166.414deg, rgb(238, 242, 255) 0%, rgb(255, 255, 255) 100%)" }}
    >
      <DecorativeIcon />
      
      <div className="position-relative z-10 p-6 lg:p-8 d-flex flex-column gap-3 lg:gap-4 w-100">
        <LymbusBadge />
        
        <h3 className="fw-bold lg:text-[22px] leading-snug lg:leading-tight tracking-tight" style={{'color':'#0f172b', 'fontSize':'18px', 'maxWidth':'800px'}}>
          Patient satisfaction is at its highest point in a year, driven by recent improvements in the West Wing.
        </h3>
        
        <div className="d-flex flex-column sm:flex-row align-items-start sm:items-center gap-4 lg:gap-8">
          <div className="d-flex gap-8">
            <div className="d-flex flex-column gap-0.5">
              <p className="fw-bold text-uppercase tracking-wider" style={{'color':'#90a1b9', 'fontSize':'10px'}}>Current Score</p>
              <p className="fw-bold lg:text-[24px] leading-none" style={{'color':'#0f172b', 'fontSize':'20px'}}>88.5</p>
            </div>
            
            <div className="d-flex flex-column gap-0.5">
              <p className="fw-bold text-uppercase tracking-wider" style={{'color':'#90a1b9', 'fontSize':'10px'}}>YoY Trend</p>
              <p className="fw-bold lg:text-[24px] leading-none" style={{'color':'#096', 'fontSize':'20px'}}>+4.2%</p>
            </div>
          </div>
          
          <button className="d-flex align-items-center gap-1.5 px-px hover:opacity-80 transition-opacity cursor-pointer group mt-1 sm:mt-0">
