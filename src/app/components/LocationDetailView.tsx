      ...
      <div className="p-4 lg:p-8 space-y-6 lg:space-y-8 max-w-7xl mx-auto">
        ...
        <div className="d-grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-8">
          ...
          <div className="lg:col-span-4 d-flex">
            <div className="bg-brand-dark p-8 text-white position-relative overflow-hidden d-flex flex-column justify-content-between shadow-xl w-100 group" style={{'borderRadius':'24px'}}>
              ...
              <div className="position-relative z-10">
                <div className="d-flex align-items-center gap-2 mb-6">
                  <div className="w-10 h-10 bg-white/10 backdrop-blur-md d-flex align-items-center justify-content-center border border-white/10" style={{'borderRadius':'12px'}}>
              ...
              <div className="position-relative z-10">
                <button className="w-100 bg-brand-blue text-white py-4 fw-bold text-xs text-uppercase tracking-widest hover:brightness-110 transition-all d-flex align-items-center justify-content-center gap-2 d-none" style={{'borderRadius':'16px'}}>
        ...
        <div className="d-grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-8">
          <div className="bg-card border border-brand-border p-6 d-flex flex-column" style={{'borderRadius':'24px'}}>
            ...
            <div className="space-y-3">
              {departmentBreakdown.map((dept, i) => (
                <div key={i} className="d-flex align-items-center justify-content-between p-4 bg-brand-bg/40 border border-brand-border/50 hover:bg-brand-bg transition-all group" style={{'borderRadius':'16px'}}>
                  <div className="d-flex align-items-center gap-4">
                    <div className="w-10 h-10 bg-white border border-brand-border d-flex align-items-center justify-content-center fw-bold text-brand-blue text-sm" style={{'borderRadius':'12px'}}>
                      {dept.name.charAt(0)}
                    </div>
                    <div>
                  ...
                  <div className="d-flex align-items-center gap-4">
                    <div className="text-end">
                      ...
                      <div className="w-24 h-1.5 bg-brand-bg rounded-circle mt-1 overflow-hidden">
          ...
          <div className="bg-card border border-brand-border p-6 d-flex flex-column" style={{'borderRadius':'24px'}}>
            <div className="d-flex align-items-center justify-content-between mb-8">
              ...
              <div className="d-flex align-items-center gap-1 px-3 py-1.5 bg-red-50 rounded-circle border border-red-100">
            ...
            <div className="flex-fill space-y-6">
              ...
              <Motion.div
                ...
                className="p-5 bg-red-50 border border-red-100 position-relative overflow-hidden" style={{'borderRadius':'16px'}}
              >
                {/* Watermark icon */}
                <div className="position-absolute -right-2 -bottom-2 pe-none">
                  <AlertCircle size={80} className="text-red-500" />
                </div>
                <div className="d-flex align-items-start gap-3.5 position-relative z-10">
                  <div className="p-2 bg-red-100 rounded-circle flex-shrink-0 mt-0.5">
