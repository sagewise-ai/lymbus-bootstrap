  ...
  <div className="d-flex flex-column gap-1.5 group">
    ...
    <div className="bg-brand-bg/50 position-relative d-flex align-items-center px-4 border border-brand-border focus-within:border-brand-blue/30 focus-within:bg-white transition-all" style={{'height':'40px', 'borderRadius':'12px'}}>
      <input 
        type="text" 
        defaultValue={value}
        className="bg-transparent w-100 text-sm fw-bold text-brand-dark focus:outline-none"
      />
    </div>
    <p className="text-brand-gray fw-medium px-1 leading-tight opacity-0 group-hover:opacity-100 transition-opacity" style={{'fontSize':'10px'}}>
      {description}
    </p>
  </div>
);
...
const RoleCard = ({ role, description, users, colorClass, badgeBg }: any) => (
  <div className="bg-card p-5 border border-brand-border d-flex align-items-center justify-content-between hover:shadow-md transition-all group" style={{'borderRadius':'16px'}}>
    ...
    <span className="fw-bold text-brand-dark bg-brand-bg px-2 py-1 rounded-2 text-uppercase tracking-widest" style={{'fontSize':'10px'}}>
      {users} users
    </span>
  </div>
);
...
const UserRolesView = () => (
  <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
    ...
    <div className="d-grid grid-cols-1 gap-3">
      <RoleCard 
        role="Admin" 
...
//             >
//               <source.icon size={14} />
//               <span className="fw-bold text-uppercase tracking-wider" style={{'fontSize':'10px'}}>{source.label}</span>
...
//             className="w-100 bg-card h-12 pl-12 pr-4 rounded-3 border border-brand-border focus:outline-none focus:ring-2 focus:ring-brand-blue/20 transition-all fw-medium text-brand-dark"
//           />
//         </div>
//       </div>
//
//       <div className="d-grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-6">
          ...
          >
              ...
              <div className="d-flex align-items-center gap-3 w-100 md:w-auto">
                <div className="position-relative group flex-fill md:w-72">
                  ...
                  <input
                    ...
                    className="w-100 bg-card h-11 pl-11 pr-4 rounded-3 border border-brand-border focus:outline-none focus:ring-2 focus:ring-brand-blue/20 transition-all text-sm fw-medium text-brand-dark"
                  />
                </div>
                ...
                <div className="position-relative">
                  ...
                  >
                    <Filter size={14} />
                    <span className="d-none sm:inline text-uppercase tracking-widest" style={{'fontSize':'10px'}}>
            ...
            <div className="bg-card border border-brand-border shadow-sm overflow-hidden" style={{'borderRadius':'24px'}}>
              ...
              <div className="d-none md:grid md:grid-cols-[1fr_130px_120px_80px_52px] gap-4 px-6 py-3 bg-brand-bg/50 border-bottom border-brand-border">
                ...
                <span className="fw-bold text-brand-gray text-uppercase tracking-widest" style={{'fontSize':'10px'}}>Status</span>
                <span className="fw-bold text-brand-gray text-uppercase tracking-widest text-end" style={{'fontSize':'10px'}}>On/Off</span>
              </div>
    ...
    <div className="d-flex align-items-start justify-content-between">
      ...
      <div className="d-flex align-items-center gap-2 opacity-0 group-hover:opacity-100 transition-opacity">
        <button 
          ...
          className="p-2 hover:bg-brand-bg rounded-3 text-brand-gray hover:text-brand-blue transition-colors"
        >
          <Edit2 size={16} />
        </button>
        <button 
          ...
          className="p-2 hover:bg-red-50 rounded-3 text-brand-gray hover:text-red-500 transition-colors"
        >
          <Trash2 size={16} />
        </button>
      </div>
