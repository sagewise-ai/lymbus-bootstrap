...
export const CampaignBuilder: React.FC<CampaignBuilderProps> = ({ onBack }) => {
    ...
    <div className="space-y-4 max-w-2xl mx-auto">
      ...
      <div className="space-y-4">
        <div className="bg-white p-4 rounded-2xl border border-brand-border shadow-sm">
          <label className="fw-bold text-uppercase tracking-widest text-brand-dark d-block mb-1.5 opacity-60" style={{'fontSize':'9px'}}>Campaign Name</label>
          <input 
            type="text" 
        ...
        <div className="bg-white p-4 rounded-2xl border border-brand-border shadow-sm d-flex align-items-center justify-content-between">
          <label className="fw-bold text-uppercase tracking-widest text-brand-dark d-block opacity-60" style={{'fontSize':'9px'}}>Outreach Channels</label>
        ...
        <div className="mt-4 pt-4 border-top border-brand-border">
            ...
            <div className="space-y-4 animate-in fade-in slide-in-from-top-2">
              <div className="d-grid grid-cols-12 gap-3">
                <div className="col-span-8">
                  <label className="fw-bold text-uppercase tracking-widest text-brand-dark d-block mb-1 opacity-60" style={{'fontSize':'9px'}}>Host <span className="text-red-500">*</span></label>
                  <input 
                    type="text" 
                ...
                <div className="col-span-4">
                  <label className="fw-bold text-uppercase tracking-widest text-brand-dark d-block mb-1 opacity-60" style={{'fontSize':'9px'}}>Port</label>
                  <input 
                    type="text" 
                    placeholder="5432" 
                    className="w-100 h-9 bg-brand-bg/30 border border-brand-border rounded-3 px-3 fw-bold outline-none focus:ring-1 focus:ring-brand-blue/30" style={{'fontSize':'10px'}} 
              ...
              <div>
                <label className="fw-bold text-uppercase tracking-widest text-brand-dark d-block mb-1 opacity-60" style={{'fontSize':'9px'}}>Database Name <span className="text-red-500">*</span></label>
                <input 
                  type="text" 
              ...
              <div className="d-grid grid-cols-2 gap-3">
                <div>
                  <label className="fw-bold text-uppercase tracking-widest text-brand-dark d-block mb-1 opacity-60" style={{'fontSize':'9px'}}>Username <span className="text-red-500">*</span></label>
                  <input 
                    type="text" 
                ...
                <div>
                  <label className="fw-bold text-uppercase tracking-widest text-brand-dark d-block mb-1 opacity-60" style={{'fontSize':'9px'}}>Password</label>
                  <input 
                    type="password" 
              ...
              <div className="d-flex align-items-center gap-4 pt-2">
                <button 
                  ...
                  className="px-6 py-2 bg-brand-blue text-white rounded-3 fw-bold text-uppercase tracking-widest shadow shadow-brand-blue/10 active:scale-95 transition-all" style={{'fontSize':'10px'}}
                  disabled={isTestingConnection}
                >
                  {isTestingConnection ? 'Testing...' : 'Test Connection'}
                </button>
                {dbConnected && (
                  <div className="d-flex align-items-center gap-1.5 animate-in fade-in slide-in-from-left-2">
          ...
          {data.source === 'upload' && (
            <div 
              ...
              className="border-2 border-dashed border-brand-border rounded-3 p-4 d-flex align-items-center justify-content-center gap-3 bg-brand-bg/20 cursor-pointer group"
            >
            ...
            <div className="space-y-4">
              <div className="d-flex gap-2">
                <input 
                  ...
                  className="flex-fill h-10 bg-brand-bg/40 border border-brand-border rounded-3 px-4 fw-bold focus:ring-1 focus:ring-brand-blue/30 outline-none" style={{'fontSize':'10px'}} 
                ...
                <button 
                  ...
                  className="px-6 bg-brand-blue text-white rounded-3 fw-bold text-uppercase tracking-widest shadow shadow-brand-blue/10 active:scale-95 transition-all" style={{'fontSize':'10px'}}
                >
                  Add
                </button>
              </div>
              {manualRecipients.length > 0 && (
                <div className="border border-brand-border rounded-2xl overflow-hidden bg-white overflow-y-auto custom-scrollbar shadow-inner" style={{'maxHeight':'320px'}}>
                   {manualRecipients.map((r, i) => (
                     <div key={i} className="d-flex align-items-center justify-content-between px-4 py-2.5 border-bottom border-brand-border last:border-0 hover:bg-brand-bg/20 transition-colors group">
  ...
  const renderContentStep = () => (
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-2xl border border-brand-border overflow-hidden shadow-sm">
        <div className="px-6 py-4 bg-brand-bg/20 border-bottom border-brand-border d-flex align-items-center justify-content-between">
           ...
           <div className="position-relative">
              <Search className="position-absolute left-3 top-1/2 -translate-y-1/2 text-brand-gray" size={12} />
              <input 
                type="text" 
      ...
      <div className="d-flex align-items-center gap-4 py-2">
         <div className="h-px flex-fill bg-brand-border" />
            ...
            <div className="d-flex flex-wrap gap-2">
              ...
              {['[Patient Name]', '[Form Link]', '[Facility Name]'].map(tag => (
                <button 
                  ...
                  className="fw-bold text-uppercase tracking-tight bg-white border border-brand-border rounded-3 px-3 py-1.5 hover:border-brand-blue hover:text-brand-blue hover:bg-brand-blue/5 transition-all shadow-sm d-flex align-items-center gap-1.5" style={{'fontSize':'9px'}}
                >
                  <Plus size={10} />
                  {tag.replace('[', '').replace(']', '')}
                </button>
  ...
  const renderScheduleStep = () => (
    <div className="bg-card p-6 lg:p-8 border border-brand-border space-y-8 max-w-2xl mx-auto shadow-sm" style={{'borderRadius':'24px'}}>
          ...
          >
             <div className="d-grid grid-cols-2 gap-8">
               {data.scheduleType !== 'range' && (
                 <div className="space-y-2">
                   <label className="fw-bold text-uppercase text-brand-gray d-block opacity-60" style={{'fontSize':'9px', 'letterSpacing':'0.2em'}}>Recurrence</label>
                   <select 
               ...
               <div className={cn("space-y-2", data.scheduleType === 'range' ? "col-span-1" : "")}>
                 <label className="fw-bold text-uppercase text-brand-gray d-block opacity-60" style={{'fontSize':'9px', 'letterSpacing':'0.2em'}}>
               ...
               {data.scheduleType === 'range' && (
                 <div className="space-y-2">
                   <label className="fw-bold text-uppercase text-brand-gray d-block opacity-60" style={{'fontSize':'9px', 'letterSpacing':'0.2em'}}>End Date</label>
                   <input 
                     type="date" 
                     className="w-100 h-11 bg-white border border-brand-border rounded-3 px-4 text-xs fw-bold focus:ring-1 focus:ring-brand-blue/30 outline-none" 
                     value={data.endDate} 
    ...
    <div className="space-y-6">
       <div className="bg-white p-8 rounded-2xl border border-brand-border shadow-xl space-y-8">
          <div className="d-flex align-items-center justify-content-between">
             ...
             <div className="d-flex align-items-center gap-2 px-4 py-2 bg-emerald-50 border border-emerald-100 rounded-circle">
          ...
          <div className="d-grid grid-cols-2 md:grid-cols-4 gap-8">
             <div className="space-y-2">
                ...
                <div className="d-flex gap-2">
                   {data.channels.map(ch => (
                     <span key={ch} className="px-3 py-1 bg-brand-bg border border-brand-border rounded-3 fw-bold text-uppercase tracking-tight d-flex align-items-center gap-1.5" style={{'fontSize':'10px'}}>
             ...
             <div className="space-y-2">
                ...
                <p className="text-xs fw-bold text-brand-dark d-flex align-items-center gap-2">
          ...
          <div className="pt-8 border-top border-brand-border d-grid grid-cols-1 md:grid-cols-2 gap-8">
             ...
             <div className="p-5 bg-brand-bg rounded-2xl border border-brand-border space-y-4">
                ...
                <div className="space-y-2">
                   <div className="d-flex align-items-center gap-2">
                      <div className="w-4 h-4 rounded bg-emerald-500 d-flex align-items-center justify-content-center text-white"><CheckCircle2 size={10} /></div>
  ...
  return (
    <div className="position-fixed top-0 bottom-0 start-0 end-0 bg-brand-bg d-flex flex-column animate-in fade-in duration-300 overflow-hidden">
      {/* Header */}
      <header className="h-20 bg-white border-bottom border-brand-border px-8 d-flex align-items-center justify-content-between flex-shrink-0 z-50">
        <div className="d-flex align-items-center gap-6">
          <button 
            onClick={handleDiscard}
            className="d-flex align-items-center gap-3 text-brand-gray hover:text-brand-dark transition-all fw-bold text-uppercase tracking-widest group px-4 py-2 hover:bg-brand-bg rounded-3 border border-transparent hover:border-brand-border" style={{'fontSize':'10px'}}
          >
        ...
        <div className="d-flex align-items-center gap-4">
          <button 
            ...
            className="d-none lg:flex align-items-center gap-2 px-5 py-2.5 rounded-3 border border-brand-border fw-bold text-brand-gray text-uppercase tracking-widest hover:bg-brand-bg transition-all active:scale-95" style={{'fontSize':'10px'}}
          >
             <FileText size={14} />
             Save Draft
          </button>
          ...
          <button 
            onClick={handleDiscard}
            className="d-none lg:flex align-items-center gap-2 px-5 py-2.5 rounded-3 border border-red-50 fw-bold text-red-500 text-uppercase tracking-widest hover:bg-red-50 transition-all active:scale-95" style={{'fontSize':'10px'}}
          >
             <Trash2 size={14} />
             Discard
          </button>
      ...
      {/* Main Body */}
      <div className="flex-fill overflow-hidden d-flex bg-brand-bg">
        {/* Step Content */}
        <div className="flex-fill overflow-y-auto custom-scrollbar d-flex flex-column">
          <div className="flex-fill p-8 lg:p-12">
            <div className="max-w-6xl mx-auto d-flex gap-12 align-items-start">
              {/* Stepper (Desktop) - Inside Canvas Left Top */}
              <nav className="d-none xl:flex flex-column gap-6 w-48 flex-shrink-0 position-sticky top-0">
                {steps.map((s, idx) => {
                  ...
                  return (
                    <button 
                      ...
                      className="d-flex align-items-center gap-3 group position-relative text-start"
                    >
                      <div className={cn(
                      ...
                      {isActive && (
                        <Motion.div 
                          ...
                          className="position-absolute -left-2 w-1 h-6 bg-brand-blue rounded-circle"
              ...
              <div className="flex-fill max-w-4xl">
                <AnimatePresence mode="wait">
                  <Motion.div
                    key={activeStep}
                    initial={{ opacity: 0, y: 10 }}
          ...
          <div className="position-sticky bottom-0 bg-white/80 backdrop-blur-md border-top border-brand-border p-6 mt-auto">
            <div className="max-w-4xl mx-auto d-flex align-items-center justify-content-between">
               ...
               <div className="d-flex align-items-center gap-6">
                 <div className="d-none sm:flex flex-column align-items-end">
                 ...
                 <button 
                    onClick={handleNext}
                    className="px-10 py-3 bg-brand-blue text-white rounded-3 fw-bold text-uppercase shadow-xl shadow-brand-blue/20 hover:bg-brand-blue/90 hover:-translate-y-0.5 transition-all d-flex align-items-center gap-3" style={{'fontSize':'11px', 'letterSpacing':'0.2em'}}
                  >
        ...
        <aside className="d-none lg:flex border-start border-brand-border bg-white flex-column" style={{'width':'400px'}}>
          <div className="px-8 py-6 border-bottom border-brand-border d-flex align-items-center justify-content-between flex-shrink-0">
             <div className="d-flex align-items-center gap-3">
             ...
             <div className="bg-brand-bg p-1 rounded-3 d-flex gap-1">
                <button 
          ...
          <div className="flex-fill overflow-y-auto custom-scrollbar p-8 d-flex flex-column align-items-center">
                ...
                <AnimatePresence mode="wait">
                  {activePreview === 'sms' ? (
                    <Motion.div 
                      ...
                      className="w-100 bg-dark border-zinc-800 p-3 d-flex flex-column shadow-2xl overflow-hidden position-relative" style={{'borderRadius':'44px', 'borderColor':'8px'}}
                    >
                       <div className="w-24 h-6 bg-dark position-absolute top-0 left-1/2 -translate-x-1/2 z-10" />
                       <div className="d-flex justify-content-between align-items-center pt-2 px-5 text-white fw-bold" style={{'fontSize':'9px'}}>
                          <span>9:41</span>
                       ...
                       <div className="flex-fill bg-zinc-100 mt-6 p-4 space-y-4 overflow-y-auto no-scrollbar pt-8">
                          <div className="text-center mb-6">
                             <p className="text-zinc-400 fw-bold text-uppercase tracking-widest" style={{'fontSize':'8px'}}>Today 9:41 AM</p>
                          </div>
                          <div className="bg-white rounded-2xl rounded-tl-none p-4 shadow-sm border border-zinc-200" style={{'maxWidth':'85%'}}>
                          ...
                          {data.formId && (
                             <div className="bg-brand-blue/5 border border-brand-blue/20 rounded-2xl p-3 d-flex align-items-center gap-3 shadow-sm">
                       ...
                       <div className="h-12 bg-white border-top border-zinc-200 p-3 d-flex gap-3">
                          <div className="flex-fill bg-zinc-100 rounded-circle" />
                    ...
                    <Motion.div 
                      ...
                      animate={{ opacity: 1, scale: 1 }}
                      exit={{ opacity: 0, scale: 0.95 }}
                      className="w-100 bg-white shadow-2xl border border-brand-border overflow-hidden d-flex flex-column" style={{'borderRadius':'24px', 'height':'550px'}}
                    >
                       ...
                       <div className="p-6 flex-fill bg-white overflow-y-auto custom-scrollbar">
                          <div className="w-14 h-14 bg-brand-blue/10 rounded-2xl d-flex align-items-center justify-content-center text-brand-blue mb-6 mx-auto">
                             <Target size={28} />
                          </div>
                          ...
                          {data.formId && (
                             <div className="mt-8 p-5 bg-brand-bg border border-brand-border rounded-2xl d-flex flex-column align-items-center gap-4 text-center group hover:border-brand-blue transition-colors shadow-sm">
                                <div className="w-12 h-12 bg-white border border-brand-border rounded-3 d-flex align-items-center justify-content-center text-brand-blue shadow-sm">
                                   <FileText size={20} />
                                </div>
                                <div>
